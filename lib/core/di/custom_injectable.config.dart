...
import 'package:harry_potter_app/core/http/custom_http_client_impl.dart' as _i9;
...
import 'package:harry_potter_app/core/modules/dio_third_module.dart' as _i12;
import 'package:harry_potter_app/src/features/home/bloc/home_bloc.dart' as _i10;
import 'package:harry_potter_app/src/features/home/data/data.dart' as _i6;
import 'package:harry_potter_app/src/features/home/domain/domain.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.Dio>(() => httpThirdModule.dio(
          gh<String>(instanceName: 'BaseUrl'),
          gh<_i4.CustomInterceptor>(instanceName: 'Interceptor'),
        ));
    gh.factory<_i7.CustomHttpClient>(() => _i9.CustomHttpClientImpl(
          gh<_i8.Dio>(),
          gh<_i7.CustomInterceptor>(),
        ));
    gh.factory<_i10.HomeBloc>(() => _i10.HomeBloc(
          gh<_i7.CustomHttpClient>(),
          gh<_i11.GetAllHousesUseCase<dynamic, dynamic>>(),
        ));
    return this;
  }
}

class _$HttpThirdModule extends _i12.HttpThirdModule {}
